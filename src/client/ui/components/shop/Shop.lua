...
local CodeInput = require("@ui/components/shop/CodeInput")
local CratesPage = require("@ui/components/shop/pages/CratesPage")
local CurrencyHolder = require("@ui/components/shop/CurrencyHolder")
local CurrencyPage = require("@ui/components/shop/pages/CurrencyPage")
local FeaturedPage = require("@ui/components/shop/pages/FeaturedPage")
local GamepassPage = require("@ui/components/shop/pages/GamepassPage")
local InterfaceController = require("@controllers/InterfaceController")
local OptionButton = require("@ui/components/buttons/OptionButton")
