...
local CrateContentsPage = require("@ui/components/shop/pages/CrateContentsPage")
local CratePurchasePrompt = require("@ui/components/shop/crates/CratePurchasePrompt")
local CrateTemplate = require("@ui/components/shop/crates/CrateTemplate")
