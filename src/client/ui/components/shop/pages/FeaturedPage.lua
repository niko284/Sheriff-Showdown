...
local FeaturedItem = require("@ui/components/shop/FeaturedItem")
local Freeze = require("@packages/Freeze")
local GamepassSlideshow = require("@ui/components/shop/GamepassSlideshow")
local Gamepasses = require("@constants/Gamepasses")
local ItemUtils = require("@utilities/ItemUtils")
local LargeFeaturedItem = require("@ui/components/shop/LargeFeaturedItem")
